...
My_QGSP_BERT_HP::My_QGSP_BERT_HP(G4int ver)
{

  G4cout << "<<< Geant4 Physics List simulation engine: My_QGSP_BERT_HP"<<G4endl;
...
void My_QGSP_BERT_HP::SetCuts()
{
  if (verboseLevel >1){
    G4cout << "My_QGSP_BERT_HP::SetCuts:";
  }  
